 ...
 * \brief   Native Uart Driver Configuration for Linux(32bit) on x86(32bit) architecture.
 *
 */

#ifndef __EPCF_INCLUDED_NATIVE_PORT_X86_32_UART_LINUX32_CONFIG_H
#define __EPCF_INCLUDED_NATIVE_PORT_X86_32_UART_LINUX32_CONFIG_H

/** \brief Maximum UART channel				*/
#define UART_MAX_CHANNEL		256
...
#endif      // __EPCF_INCLUDED_NATIVE_PORT_X86_32_UART_LINUX32_CONFIG_H
